...
.Geplant
====
Dieses Kapitel beschreibt die Schritte M9 und M10. Gebaut sind zurzeit
M1 bis M7. Du kannst es lesen, aber noch nicht nachbauen.
====
...
22. August 2026 anstand? Dieses Kapitel beantwortet das, bevor Kapitel 9 und
10 zeigen, wie Anwendungen aus diesen Daten entstehen.
