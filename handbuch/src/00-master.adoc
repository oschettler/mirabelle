= PDA: Ein Taschencomputer zum Selberbauen
Olav Schettler
:doctype: book
:toc: left
:toclevels: 2
...
:description: Handbuch und Lehrbuch zum PDA-Projekt: ein PIM-Paket im Stil von Macintosh System 1, gebaut in C und Lua, von der ersten Bitmap bis zum eigenen Gerät.
:keywords: C, Lua, SDL3, ESP32, Bitmapgrafik, Macintosh System 1, Gemtext

[preface]
== Vorwort

Dieses Buch beschreibt ein Programm, das es zu großen Teilen noch nicht gibt.

Das klingt nach einem schlechten Anfang, ist aber Absicht. Das PDA-Projekt
entsteht Kapitel für Kapitel, und dieses Handbuch wächst mit. Wer es von vorne
nach hinten liest, baut ein vollständiges kleines Betriebssystem für
persönliche Daten: Aufgaben, Kalender, Adressbuch, Notizen, in der Optik des
ersten Macintosh von 1984, geschrieben in C, erweiterbar in Lua, und am Ende
auf einem eigenen Gerät mit Sieben-Zoll-Bildschirm.
...
lesen. Willst du das Programm nur benutzen, reichen die ersten drei Kapitel.
Interessiert dich, wie ein Fenstersystem funktioniert, spring zu Kapitel 6.

Jedes Kapitel beginnt mit einem Kasten, der sagt, was darin gebaut wird und
welchen Stand das Projekt dabei hat.

[IMPORTANT]
.Was es schon gibt und was nicht
====
Das Projekt entsteht in siebzehn Schritten, die im Fahrplan `ROADMAP.md`
stehen. Zurzeit sind die Schritte M1 bis M7 fertig: Grafik, Schrift,
Plattformschicht, Eingabe, Fenster, Menüs und Dialoge.

Kapitel über spätere Schritte beschreiben, was *geplant* ist. Sie sind mit
einem Hinweis „Geplant" gekennzeichnet. Du kannst sie lesen, aber noch nicht
nachbauen — und du sollst wissen, woran du bist. Ein Handbuch, das den
Unterschied verwischt, ist ärgerlicher als eines, das eine Lücke zugibt.
====
...
include::09-lua.adoc[leveloffset=+1]

include::10-api.adoc[leveloffset=+1]

include::11-erweitern.adoc[leveloffset=+1]

include::12-testen.adoc[leveloffset=+1]

include::13-geraet.adoc[leveloffset=+1]

include::14-glossar.adoc[leveloffset=+1]
