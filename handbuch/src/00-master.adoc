...
|Kapitel 9, dann 10 und 11, dann 13

|verstehen willst, wie geprüft wird
|Kapitel 14 — es lohnt sich früher, als man denkt

|es auf ein Gerät bringen willst
|Kapitel 15, und vorher `DESIGN.md` Abschnitt 12
|===
...
include::12-netz.adoc[leveloffset=+1]

include::13-erweitern.adoc[leveloffset=+1]

include::14-testen.adoc[leveloffset=+1]

include::15-geraet.adoc[leveloffset=+1]

include::16-glossar.adoc[leveloffset=+1]
