...
Das PDA-Projekt ist ein kleines Betriebssystem für persönliche Daten:
Aufgaben, Kalender, Adressbuch, Notizen, in der Optik des ersten Macintosh von
1984, geschrieben in C, erweiterbar in Lua, und am Ende auf einem eigenen
Gerät mit Sieben-Zoll-Bildschirm.

Es ist absichtlich klein. Der Bildschirm hat ein Bit je Pixel, das
Dateiformat drei Regeln, die Schnittstelle zur Außenwelt achtzehn Funktionen.
