...
| Schließfeld (Go-Away Box) | 11 × 11 px | Sitzt oben links in der Titelzeile. Abstand: 4 px von oben, 9 px von links. Ober- und Unterkante liegen genau auf der ersten und der letzten der sechs Linien — sechs Linien im Abstand von 2 px überspannen 11 Pixel, ein 12 px hohes Feld endete eine Zeile darunter. |
